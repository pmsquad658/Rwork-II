...
# 2. 모델 설명력 : 0.7462 -> x,y 상관계수   # 통상 0.65 기준으로 잡음 # 다중회귀의 경우 상관계수로
...
p-value = 0.7824 >= 0.05   # 귀무가설 : 서로 연관성이 없다에 대한 테스트(t-test와 반대)
...
# 다시 검사해 보면 true 값이 없어진 것을 볼 수 있다 
...
insurance <- read.csv('C://R/Rwork-II/data/insurance.csv', header = T)
